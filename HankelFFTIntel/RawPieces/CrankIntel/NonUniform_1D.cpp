...
complex *gam1=new complex[ndimz+nex];
...
int main()
{
	...
	phi=   new complex[ndimz+nex];
	rv=    new complex[ndimz+nex];
	phil=  new complex[ndimz+nex];
	a=     new complex[ndimz+nex];
	b=     new complex[ndimz+nex];
	c=     new complex[ndimz+nex];
	v=     new double[ndimz+nex];
	rho=   new double[ndimz+nex];
	drr=   new double[ndimz+nex];
