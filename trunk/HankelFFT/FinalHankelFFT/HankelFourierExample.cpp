...
//To compile do:
//g++ -framework Accelerate HankelFourierExample.cpp -lfftw3
...
int main()
{
	...
	//Plans for the 1D transformations.
	fftw_plan pf[Nr];
	for(int j=0;j<Nr;j++)
	...
	//Information for the propagation
	double K=6.4387e+04;
	...
	for (int gg=0;gg<Nz;gg++)
	{
		...
		//This gives f2 after the transformation
		for(int j=0;j<Nr;j++)
			for(int i=0;i<Nt;i++)
			{		
